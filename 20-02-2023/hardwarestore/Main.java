...
// 3. Create a class called Invoice that a hardware store might use to represent an invoice for an item sold
...
class InvoiceTest {
    public void Init() {
        ...
        System.out.println( String.format("Invoice total: %s", total) );
